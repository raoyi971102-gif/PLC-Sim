...
#define MyAppName "OpcUaSim"
#define MyAppPublisher "Uni-Lab"
#define MyAppExeName "OpcUaSim.exe"
...
OutputBaseFilename=OpcUaSim-Setup-Windows-x64-v{#MyAppVersion}
...
[Files]
Source: "{#SourcePath}\..\dist\OpcUaSim\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
