...
set "PY="
set "OPCUASIM_EXISTING_VENV_INVALID="

if exist "%OPCUASIM_ROOT%\.venv\Scripts\python.exe" (
  call :accept_python "%OPCUASIM_ROOT%\.venv\Scripts\python.exe"
  if not defined PY set "OPCUASIM_EXISTING_VENV_INVALID=1"
  goto :eof
)
